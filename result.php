                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                             ...
                             <center>   <img src="images/aiti.png" alt="" width="350" height="50"> </center>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <thead style="text-transform: uppercase;">
                                                        <tr style="text-align: center">
                                                            ...
                                                            <td colspan="3" style="text-align: center;"> <b> <?php echo htmlentities($row->courses_name);?></b></td>
                                                             <td rowspan="2" style="text-align: center"><b>Pass Marks</b></td>
                                                            <td rowspan="2" style="text-align: center"><b>Your Marks</b></td>
                                                             <td rowspan="2" style="text-align: center"><b>Grades</b></td>
                                                        </tr>

                                                        <tr>
      <td colspan="2"><b> Modules </b></td>
...
<tr>
<th scope="row" colspan="4" style="text-align: center">Percentage Pass Score  = <b> 50% </b></th>     
...
if($perscore >= 0 && $perscore <= 49){
    echo ("  <i style= 'color: red; font-weight: bolder; '>  FAIL    </i>   ");
}


else if($perscore >= 50 && $perscore <= 100){
    echo ("<i style= 'color: green; font-weight: bolder; '>  PASS    </i>");
...
<br><br><br><br><br>
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
         ...
         <a href="index.php"> <img src="images/back.png" alt="" width="16px" height="16px">  </a>
