...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->courses_name);?></td>
                                                            <td><?php echo htmlentities($result->coursenamenumeric);?></td>
                                                            <td><?php echo htmlentities($result->course_level);?></td>
