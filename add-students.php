...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  admission_table(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status)";
