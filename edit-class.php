...
$sql="update  courses set courses_name=:courses_name,coursenamenumeric=:coursenamenumeric,course_level=:course_level where id=:cid ";
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="text" name="courses_name" value="<?php echo htmlentities($result->courses_name);?>" required="required" class="form-control" id="success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="coursenamenumeric" value="<?php echo htmlentities($result->coursenamenumeric);?>" required="required" class="form-control" id="success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="course_level" value="<?php echo htmlentities($result->course_level);?>" class="form-control" required="required" id="success">
